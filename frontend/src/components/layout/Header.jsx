  ...
  return (
    <header className="header">
      ...
      <div
        style={{
          ...s.searchPill,
          borderColor: searchFocus ? 'rgba(2,115,94,0.35)' : 'rgba(0,0,0,0.10)',
          boxShadow: searchFocus ? '0 0 0 2px rgba(2,115,94,0.08)' : 'none',
        }}
      ...
      >
        ...
        <input
          ...
          type="text"
          placeholder="Cámaras, alertas, proveedores…"
          style={s.searchInput}
          aria-label="Buscar"
      ...
      <div style={s.secBadge} className="header-status" title="Nivel de seguridad actual">
        <IconShield />
        ...
        {notifOpen && (
          <div style={s.notifPanel}>
            <div style={s.notifHead}>
              <span style={s.notifTitle}><MayiaMark size={13} color="#02735E" /> MAYIA</span>
              {archive.length > 0 && (
...
const s = {
  ...
  statusDot: {
    ...
    boxShadow: '0 0 6px rgba(2,115,94,0.6)',
  ...
  secBadge: {
    ...
    alignItems: 'center',
    gap: 4,
    background: 'rgba(214,217,137,0.15)',
    border: '1px solid rgba(214,217,137,0.35)',
    borderRadius: 12,
    padding: '3px 8px',
    flexShrink: 0,
  },
  ...
  badge: {
    ...
    boxShadow: '0 0 6px rgba(197,48,48,0.35)',
  },
  notifPanel: {
  ...
  notifClear: {
    ...
    color: '#02735E', fontSize: 11, fontWeight: 700, cursor: 'pointer',
  },
  ...
  avatar: {
    width: 30, height: 30,
    borderRadius: '50%',
    background: 'linear-gradient(135deg, #02735E, #08261E)',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    color: '#fff',
    flexShrink: 0,
    cursor: 'pointer',
    boxShadow: '0 2px 8px rgba(2,115,94,0.30)',
  },
}
